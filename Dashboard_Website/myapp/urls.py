...
urlpatterns = [
	...
	url(r"^create_query/delete_all_variables_handler/$",views.delete_all_variables_handler,name="delete_all_variables_handler"),
	...
	url(r"^create_query/view_custom_metric_handler/$", views.view_custom_metric_handler, name="view_custom_metric_handler"),
